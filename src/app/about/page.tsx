      ...
      <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
        ...
        <div className="lg:order-first lg:row-span-2">
          <div className="mt-6 space-y-7 text-base  text-zinc-400">
            ...
            <p>Professionally, I've worked as a <span className='font-semibold text-zinc-300'>UX Engineer, Data Scientist, AI Consultant,</span> and <span className='font-semibold text-zinc-300'>Developer</span> on some of the most complex, exciting <span className='font-semibold text-zinc-300'>MedTech systems</span> in the world (including surgical robots, neurological implants, digital health, prostheses, etc.)</p>
            <p>Personally, I'm a <span className='font-semibold text-zinc-300'>Tinkerer, Videographer, Graphics Artist, Oil Painter</span>, and aspiring <span className='font-semibold text-zinc-300'>Coffee Snob</span> ☕️🤔 - I showcase and document my work on my&nbsp;
              <Link
                href={'/projects'}
                className='hover:text-teal-200 text-teal-400 font-semibold hover:undezinc-200 underline-offset-2'
              >projects
