      ...
      <Container className="mt-9">
        ...
        <div className="max-w-2xl">
          ...
          <div className="flex flex-col gap-2 mt-6 text-base text-zinc-400">
            ...
            <p>I proudly research, design, develop, test complex, wonderful products - Including surgical robots, neurostim implants, satellite and comms, AI powered applications and more! <br /> ( <span className='italic font-thin'>No that you asked, but I'm also big into videography, painting, and coffee</span> ☕️ ) </p>
          </div>
